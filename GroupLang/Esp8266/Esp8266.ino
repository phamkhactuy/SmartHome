...
char host[] = "peaceful-lake-63408.herokuapp.com";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
//peaceful-lake-63408.herokuapp.com
int port = 80;  //80                  //Cổng dịch vụ socket server do chúng ta tạo!
